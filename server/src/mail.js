...
export const sendVerificationCodeEmail = async ({ to, code }) => {
  ...
  const text = `Your Frakktur verification code is: ${code}. It expires in 10 minutes.`;
  const html = `<p>Your Frakktur verification code is:</p><h2 style=\"letter-spacing:4px\">${code}</h2><p>This code expires in 10 minutes.</p>`;
